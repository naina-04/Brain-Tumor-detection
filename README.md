...
```bash
git clone https://github.com/naina-04/Brain-Tumor-detection.git
...
- **GitHub Issues:** [Report bugs or request features](https://github.com/naina-04/Brain-Tumor-detection/issues)
- **Repository:** [View source code](https://github.com/naina-04/Brain-Tumor-detection)
